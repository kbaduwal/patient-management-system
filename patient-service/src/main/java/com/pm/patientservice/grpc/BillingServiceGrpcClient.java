...
public class BillingServiceGrpcClient {
    ...
    //Anytime we make call to the billing service using "blockingStub"
    //it wait for the response from the billing service before it continues
    // Synchronous microservice communication (1-1 microservice)
